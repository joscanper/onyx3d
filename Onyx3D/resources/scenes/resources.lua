...
texture("tilesD", "resources/textures/floor1/diffuse.png")
texture("tilesR", "resources/textures/floor1/roughness.png")
texture("tilesN", "resources/textures/floor1/normal.png")